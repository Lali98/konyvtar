...
{
    private $sql = array(
        'allBooks' => ' select b.id, b.title, b.lang, b.page_size, b.release_date, a.name as "author", group_concat(c.name separator ", ") as "category" from books b left join authors a on b.author_id = a.id left join books_categories bc on b.id = bc.book_id left join categories c on bc.category_id = c.id group by b.title',
